...
class PHDetailScreen extends StatefulWidget {
  const PHDetailScreen({super.key});

  @override
  State<PHDetailScreen> createState() =>
      _PHDetailScreenState();
}
...
class _PHDetailScreenState
    extends State<PHDetailScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "A pHCa range between 5 and 6 is considered ideal for most plants. Acid soils have a major effect on plant productivity once the soil pHCa falls below 5: pH 6.5 — close to neutral — Optimum for many acid-sensitive plants. Some trace elements may become unavailable.",

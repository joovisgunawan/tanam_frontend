/////////////////////////////////////////////////////////////////
// ignore_for_file: dangling_library_doc_comments, use_super_parameters, library_private_types_in_public_api, avoid_print
...
class _MQTTClientState extends State<MQTTClient> {
  ...
  final MqttServerClient client = MqttServerClient('mqtt.tanam.software', '');
      ...
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            img.Image jpegImage = img
                .decodeJpg(recMess.payload.message as Uint8List) as img.Image;

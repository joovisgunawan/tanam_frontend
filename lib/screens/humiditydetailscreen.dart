...
class HumidityDetailScreen extends StatefulWidget {
  const HumidityDetailScreen({super.key});

  @override
  State<HumidityDetailScreen> createState() =>
      _HumidityDetailScreenState();
}
...
class _HumidityDetailScreenState
    extends State<HumidityDetailScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "The Effects of Humidity on Plants, Relative humidity levels affect when and how plants open the stomata on the undersides of their leaves. Plants use stomata to transpire, or “breathe.” When the weather is warm, a plant may close its stomata to reduce water losses. The stomata also act as a cooling mechanism.",

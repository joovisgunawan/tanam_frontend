...
class TdsDetailScreen extends StatefulWidget {
  const TdsDetailScreen({super.key});

  @override
  State<TdsDetailScreen> createState() =>
      _TdsDetailScreenState();
}
...
class _TdsDetailScreenState
    extends State<TdsDetailScreen> {
  ...
  fetchSensor() async {
    ...
    setState(() {
      chartData = sensorList.map((data) {
        ...
        return ChartData(
          timestamp,
          double.parse(data['tds'].toString()),
        );
      }).toList();
      isLoading = false;
        ...
        child: Column(
          ...
          children: [
                          ...
                          SfCartesianChart(
                            ...
                            onTooltipRender: (TooltipArgs args) {
                              if (args.pointIndex != null &&
                                ...
                                args.text =
                                    '${DateFormat('MMM d, HH:mm').format(data.x)}: ${data.y} ppm';
                              }
                            },
            ...
            const Padding(
              ...
              child: Text(
                "The salt concentration in most irrigation waters ranges from 200 to 4 000 mg/litre total dissolved solids (TDS). The pH of the water is also an indicator of its quality and it normally ranges from 6.5 to 8.4. The sum of cations should equal the sum of anions.",

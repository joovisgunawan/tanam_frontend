...
class AirTemperatureDetailScreen extends StatefulWidget {
  const AirTemperatureDetailScreen({super.key});

  @override
  State<AirTemperatureDetailScreen> createState() =>
      _AirTemperatureDetailScreenState();
}
...
class _AirTemperatureDetailScreenState
    extends State<AirTemperatureDetailScreen> {
  ...
  fetchSensor() async {
    ...
    setState(() {
      chartData = sensorList.map((data) {
        ...
        return ChartData(
          timestamp,
          double.parse(data['airTempC'].toString()),
        );
      }).toList();
      isLoading = false;
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                "Temperature plays a crucial role in agriculture, influencing crop growth, development, and overall productivity. Temperature management is integral to agricultural success, influencing every stage of crop growth, from germination to harvest. Farmers and agricultural professionals rely on accurate temperature data to optimize crop management practices and maximize productivity in a changing climate.",
